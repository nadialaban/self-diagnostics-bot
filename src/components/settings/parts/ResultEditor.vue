    ...
    <div class="row">
      <field title="Иконка" col="4" :error="errors.icon">
        <select class="custom-select" v-model="result.icon"
          ...
          <option v-for="icon in icons.results" :value="icon.file_name"
      ...
      <div class="text-center col-2" style="margin-top: 25px;">
        <img v-if="result.icon && result.color" :src="img_url(result.color, result.icon)" width="60px">
      </div>
    </div>
